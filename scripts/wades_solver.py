...
def print_solution(data: dict, routing: pywrapcp.RoutingModel,
                   manager: pywrapcp.RoutingIndexManager, assignment: pywrapcp.Assignment):
    """
    Print routes on console.
    """
    print("Hello this is in print solution!")
    ...
    for vehicle_id in range(data['num_vehicles']):
        ...
        while not routing.IsEnd(index):
            props = node_properties(routing,manager, assignment, capacity_dimension,
...
def main():
    ...
    manager = pywrapcp.RoutingIndexManager(len(data['weights']), len(data['vehicle_capacities']), data['depot'])
    ...
    add_time_window_constraints(routing, manager, data, time_callback,transit_callback_index)
